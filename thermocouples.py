...
def points_graphs (coefficient):
    ...
    while temperature <= 300:
        for const in coefficient:
            soma = const*pow(temperature, (coefficient.index(const)))
            aux_soma += soma
...
def main():
    ...
    plt.plot(points_graphs(thermocouple_typeB()), label = 'Type B')
    plt.plot(points_graphs(thermocouple_typeE()), label = 'Type E')
    plt.plot(points_graphs(thermocouple_typeJ()), label = 'Type J')
    plt.plot(thermocouple_typeK(), label = 'Type K')
    plt.plot(points_graphs(thermocouple_typeN()), label = 'Type N')
    plt.plot(points_graphs(thermocouple_typeR()), label = 'Type R')
    plt.plot(points_graphs(thermocouple_typeS()), label = 'Type S')
    plt.plot(points_graphs(thermocouple_typeT()), label = 'Type T')
